...
class NerLanguageBias:
    ...
    NER.subwords_to_concat_list = NER.regression_predicted_subwords()
    ...
    NER.list_Corpus_books = ['The_Great_Gatsby']    ## , 'Dracula' , 'Adventures_of_Huckleberry_Finn', 
    ...
    def scan(self, model: Pipeline, params: dict) -> pd.DataFrame:
        ...
        res = {}
        print("starting NER of the books...")
